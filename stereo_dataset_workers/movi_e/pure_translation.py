...
# Pose of the stereo rig won't change over time (just the positions of the cameras translate linearly)
quaternion = outs['quaternion']
look_at_right = outs['look_at_right']
...
for frame in range(FLAGS.frame_start - 1, FLAGS.frame_end + 2):
  ...
  left_cam.quaternion = quaternion

  right_cam.position = right_pos
  right_cam.quaternion = quaternion
